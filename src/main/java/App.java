...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to our dealership. What would you like to do? Enter one of the following options: All Vehicles, Search Price, Add Vehicle, or Exit");
